...
async function onRequest({ request, env }) {
  ...
  const resultado = {
    DATABASE_URL: env.DATABASE_URL ? "\u2705 Configurada" : "\u274C FALTA \u2014 agr\xE9gala en Cloudflare Pages > Variables",
    JWT_SECRET: env.JWT_SECRET ? "\u2705 Configurada" : "\u26A0\uFE0F  Falta (usar\xE1 valor por defecto)",
    db_conexion: null,
    usuarios_en_db: null,
